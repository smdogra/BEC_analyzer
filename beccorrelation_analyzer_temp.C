...
void beccorrelation_analyzer_temp(TString input_file, TString ouputfilename, int MCSim, bool isEventMix){
  ...
  // Vectors used for objects
    ...
    for (int j = 0; j < trksize; j++){ 
      ...
      cout<< trkpixhits[j]	  <<  " Pixel Hits" << endl;
      //if(trkNPixelHit[j]< 1) continue;
